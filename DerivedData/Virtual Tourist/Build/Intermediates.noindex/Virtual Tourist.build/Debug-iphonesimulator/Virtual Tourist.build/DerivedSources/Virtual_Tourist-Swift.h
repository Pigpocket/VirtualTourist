...
SWIFT_MODULE_NAMESPACE_PUSH("Virtual_Tourist")
@class UIWindow;
@class UIApplication;
...
SWIFT_CLASS("_TtC15Virtual_Tourist24CollectionViewController")
@interface CollectionViewController : UIViewController <NSFetchedResultsControllerDelegate, MKMapViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate>
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified newCollectionButton;
@property (nonatomic, weak) IBOutlet MKMapView * _Null_unspecified mapView;
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified collectionView;
@property (nonatomic, weak) IBOutlet UICollectionViewFlowLayout * _Null_unspecified collectionFlow;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified noImagesLabel;
- (IBAction)newCollectionAction:(id _Nonnull)sender;
- (void)viewDidLoad;
...
@interface Images (SWIFT_EXTENSION(Virtual_Tourist))
...
@property (nonatomic, weak) IBOutlet MKMapView * _Null_unspecified mapView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified deletePinsLabel;
- (void)viewDidLoad;
- (void)setEditing:(BOOL)editing animated:(BOOL)animated;
- (void)handleLongPress:(UIGestureRecognizer * _Nonnull)gestureRecognizer;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface MapViewController (SWIFT_EXTENSION(Virtual_Tourist)) <UIGestureRecognizerDelegate>
...
- (void)addImagesObject:(Images * _Nonnull)value;
- (void)removeImagesObject:(Images * _Nonnull)value;
